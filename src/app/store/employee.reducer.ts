...
import { addEmployeeSuccess, deleteEmployeeSuccess, getEmployee, loadEmployee, loadEmployeeError, loadEmployeeSuccess, updateEmployeeSuccess } from "./employee.action";
...
const _employeeReducer=createReducer(employeeState, 
    ...
    on(loadEmployeeError, (state, action) => {
        return {
            ...state,
            list:[],
