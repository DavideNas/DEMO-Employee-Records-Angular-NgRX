...
```bash
git clone [https://github.com/DavideNas/DEMO-Employee-Records-Angular-NgRX.git](https://github.com/DavideNas/DEMO-Employee-Records-Angular-NgRX.git)
cd DEMO-Employee-Records-Angular-NgRX
